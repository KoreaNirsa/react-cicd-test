...
function Board() {
  ...
  const boardPosts = Object.values(postsData.board);
    ...
    <>
      ...
      <div className="container">
        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem'}}>
          <h1>자유게시판</h1>
          <Link to="/board-write" className="btn btn-primary" style={{textDecoration: 'none'}}>글쓰기</Link>
        </div>
        <div className="post-list">
          {Object.entries(postsData.board).map(([id, post]) => (
            <div key={id} className="post-item" onClick={() => goBoardDetail(parseInt(id))}>
