...
function BoardDetail() {
  ...
  const [post, setPost] = useState(postsData.board[postId] || postsData.board[1]);
  ...
  return (
    <>
      ...
      <div className="container">
        <Link to="/board" style={{color: 'var(--accent)', textDecoration: 'none', marginBottom: '1rem', display: 'inline-block'}}>← 목록으로 돌아가기</Link>
        ...
        <div className="post-detail">
          <div className="detail-header">
            ...
            <div className="detail-actions">
              <Link to={`/board-edit/${postId}`} className="btn btn-secondary" style={{textDecoration: 'none'}}>수정</Link>
